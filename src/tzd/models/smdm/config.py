...
class Config:
    ...
    def norm_class(self) -> Type:
        ...
        if self._norm_class == "RMSNorm":
            ...
            # NOTE: installing dropout_layer_norm was kinda tricky. (https://github.com/Dao-AILab/flash-attention/issues/131)
            #       so we are doing a fallback to RMSNorm like litgpt does too?
            warnings.warn("FusedRMSNorm is not supported. Falling back to RMSNorm.")
            from .rmsnorm import RMSNorm
            return RMSNorm
